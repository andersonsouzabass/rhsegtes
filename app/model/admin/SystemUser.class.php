...
class SystemUser extends TRecord
{
    ...
    public function cloneUser()
    {
        ...
        $fornecedor = $this->getUsuarioFornecedor();
        ...
        if ($fornecedor)
        {
            ...
            {
                $this->addUsuarioFornecedor( $fornecedor );
            }
        }
    }
   ...
   /**
     ...
     */
    public function addUsuarioFornecedor(Pessoa $fornecedor)
    {
        $object = new UsuarioFornecedor;
        $object->fornecedor_id = $fornecedor->id;
        $object->system_user_id = $this->id;
        $object->store();
    }
     ...
     */
    public function getUsuarioFornecedor()
    {
        return parent::loadAggregate('Pessoa', 'UsuarioFornecedor', 'system_user_id', 'fornecedor_id', $this->id);
    }
    ...
    public function clearParts()
    {
        ...
        UsuarioFornecedor::where('system_user_id', '=', $this->id)->delete();
    }
    ...
    public function delete($id = NULL)
    {
        ...
        UsuarioFornecedor::where('system_user_id', '=', $id)->delete();
    ...
    */
    ...
    //Função para relacionar os acessos dos usuários do censo
    public function addUsuarioUnidadeCenso(Unidade2 $unidade2)
    {
        $object = new UsuarioUnidade;
        $object->system_user_id = $this->id;
        $object->folha_unidade_2_id = $unidade2->id;
        $object->store();
    }
    
    public function getUsuarioUnidade()
    {
        return parent::loadAggregate('Unidade2', 'UsuarioUnidade', 'system_user_id', 'folha_unidade_2_id',  $this->id);
    }
}
