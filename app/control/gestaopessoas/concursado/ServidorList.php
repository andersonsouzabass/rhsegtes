...
class ServidorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_servidor_list');
        $this->form->setFormTitle('Lista de Pessoas');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['ServidorForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
