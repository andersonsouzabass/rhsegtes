...
class ServidorFormView extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        $this->form->setFormTitle('Servidor');
    ...
    public function onEdit($param)
    {
        try
        {
            ...
            $label_nome_fantasia = new TLabel('Nome:', '#333333', '12px', '');
            $label_codigo_nacional = new TLabel('CPF:', '#333333', '12px', '');   
            ...
            $text_nome_fantasia  = new TTextDisplay($master_object->nome, '#333333', '12px', '');
            $text_codigo_nacional  = new TTextDisplay($master_object->cpf, '#333333', '12px', '');           
