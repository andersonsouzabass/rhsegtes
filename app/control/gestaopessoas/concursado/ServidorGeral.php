 ...
 * 
 */
class ServidorGeral extends TPage
{
    ...
    public function __construct()
    {
        ...
        */
        ...
        $this->addFilterField('vinculo', 'like', 'vinculo'); // filterField, operator, formField
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_servidorgeral_list');
        $this->form->setFormTitle('Profissionais - Lista de Pessoas');
        ...
        $vinculo = new TDBCombo('vinculo', 'gratifica', 'ViewVinculoServidor', 'vinculo', 'vinculo');   
        $situacao = new TDBCombo('situacao', 'gratifica', 'ViewVinculoServidor', 'situacao', 'situacao');   
        ...
        $this->form->addFields( [ new TLabel('Função') ], [ $funcao ] );
        ...
        */
        ...
        $row = $this->form->addFields(  [ new TLabel('Vínculo'), $vinculo ],
        ...
        */
        ...
        $column_vinculo = new TDataGridColumn('vinculo', 'Vínculo', 'left');
 ...
 //Ordenar as colunas
        ...
        $column_situacao->setAction(new TAction([$this, 'onReload']), ['order' => 'situacao']);
        ...
        */
        ...
        $column_nome->setAction(new TAction([$this, 'onReload']), ['order' => 'nome']);
        $column_unidade->setAction(new TAction([$this, 'onReload']), ['order' => 'unidade']);
        $column_vinculo->setAction(new TAction([$this, 'onReload']), ['order' => 'vinculo']);
        
        $column_ativo->enableAutoHide(500);
        
        $action1 = new TDataGridAction(['ServidorFormView', 'onEdit'], ['id'=>'{s_id}']);
