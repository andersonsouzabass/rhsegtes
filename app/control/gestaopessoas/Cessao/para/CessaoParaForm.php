...
class CessaoParaForm extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Cedido Para Outros Orgãos');
        ...
        $detail_unidade_id = new TDBUniqueSearch('detail_unidade_id', 'rh', 'ViewUnidadeUsuario', 'id', 'nome', null, TCriteria::create( ['system_user_id' => $id_logado] )); //ok
        ...
        $detail_especialidadefolha_id->setEditable(FALSE);
    ...
    public static function onDetailEdit( $param )
    {
        ...
        $criteria = TCriteria::create( ['cargo_id' => $param['cargo_id'] ] );
            ...
            TDBCombo::reloadFromModel('form_Cessao_Para', 'detail_especialidade_id', 'rh', 'ViewEspecialidadeCargo', 'id', 'nome', null, $criteria, TRUE);
        ...
        try
        {
            ...
            if( isset($param['ServidorVinculo_list_vinculo_id'] ))
            {
                foreach( $param['ServidorVinculo_list_vinculo_id'] as $key => $item_id )
                {
                    ...
                    $detail->situacao = 'A DISPOSIÇÃO DE OUTRO ORGÃO';
