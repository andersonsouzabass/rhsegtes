 ...
 * @package    
 */
class FaltasRelat extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('ViewFaltas');   // defines the active record
        ...
        $this->setOrderCommand('nome', '(SELECT nome FROM view_faltas WHERE view_faltas.id=id)');
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Faltas');
        $this->form->setFormTitle('Relatório de Faltas');
        

        // create the form fields
        //$id = new TEntry('id');
        $nome = new TDBUniqueSearch('nome', 'gratifica', 'ViewFaltas', 'id', 'nome');
        $matricula = new TEntry('matricula');
        $unidade = new TDBUniqueSearch('unidade', 'gratifica', 'ViewFaltas', 'id', 'unidade');
