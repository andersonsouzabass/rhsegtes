 ...
 * 
 */
class AfastamentoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        */
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_afastamento_list');
        $this->form->setFormTitle('Afastamento - Lista de Pessoas');
 ...
 //Ordenar as colunas
        ...
        */
        ...
        $action1 = new TDataGridAction(['AfastamentoForm', 'onEdit'], ['id'=>'{id}']);
