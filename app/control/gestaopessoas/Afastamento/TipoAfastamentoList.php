 ...
 * 
 */
class TipoAfastamentoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_tipo_afastamento_list');
        $this->form->setFormTitle('Lista de Tipos de Afastamento');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['TipoAfastamentoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['TipoAfastamentoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = TipoAfastamento::find($param['id']);
            
            if ($srv instanceof TipoAfastamento)
            {
