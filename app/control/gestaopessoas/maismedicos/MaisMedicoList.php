 ...
 * 
 */
class MaisMedicoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_maismedico_list');
        $this->form->setFormTitle('Mais Médicos - Lista de Pessoas');
        ...
        //$this->form->addActionLink('Cadastrar Mais Médico', new TAction(['MaisMedicoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['MaisMedicoForm', 'onEdit'], ['id'=>'{id}']);
