 ...
 */
class MaisMedicoForm extends TWindow
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_MaisMedico');
        $this->form->setFormTitle('Mais Médicos');
        ...
        $detail_especialidadefolha_id = new TDBUniqueSearch('detail_especialidadefolha_id', 'gratifica', 'EspecialidadeFolha', 'id', 'nome', null, TCriteria::create( ['ativo' => 'sim'] )); //ok
        ...
        $row = $this->form->addFields(  [ new TLabel('Conselho de Categoria'), $detail_conselho_desc ],
                                        ...
                                        [ new TLabel('Ciclo'), $detail_instrumento_legal ],                 
        ...
        $this->form->addHeaderActionLink( _t('Close'),  new TAction(['MaisMedicoList', 'onReload']), 'fa:times red' );
        
        $btn = $this->form->addAction(_t('Save'), new TAction([$this, 'onSave'], ['static'=>'1']), 'fa:save');
        $btn->class = 'btn btn-sm btn-primary';
       
        $this->form->addActionLink('Cancelar',  new TAction(['MaisMedicoList', 'onReload']),  'fa:times red' );
    ...
    public function onDetailAdd( $param )
    {
        try
        {
            ...
            TForm::sendData( 'form_MaisMedico', $data, false, false );
        }
        catch (Exception $e)
        {
    ...
    public static function onDetailEdit( $param )
    {
        ...
        $criteria = TCriteria::create( ['cargo_id' => $param['cargo_id'] ] );
            ...
            TDBCombo::reloadFromModel('form_MaisMedico', 'detail_especialidade_id', 'gratifica', 'ViewEspecialidadeCargo', 'id', 'nome', null, $criteria, TRUE);
    ...
    function onSave($param)
    {
        try
        {
            ...
            TForm::sendData('form_MaisMedico', (object) ['id' => $master->id]);
    ...
    public static function onListaEspecialidade($param)
    {
        try
        {
            ...
            {
                TDBCombo::clearField('form_MaisMedico', 'detail_especialidade_id');
            }
