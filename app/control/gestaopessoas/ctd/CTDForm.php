...
class CTDForm extends TWindow
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_CTD');
        $this->form->setFormTitle('Contrato por Tempo Determinado');
        ...
        $this->form->addHeaderActionLink( _t('Close'),  new TAction(['CTDList', 'onReload']), 'fa:times red' );
        
        $btn = $this->form->addAction(_t('Save'), new TAction([$this, 'onSave'], ['static'=>'1']), 'fa:save');
        $btn->class = 'btn btn-sm btn-primary';
       
        $this->form->addActionLink('Cancelar',  new TAction(['CTDList', 'onReload']),  'fa:times red' );
    ...
    public function onDetailAdd( $param )
    {
        try
        {
            ...
            TForm::sendData( 'form_CTD', $data, false, false );
        }
        catch (Exception $e)
        {
    ...
    public static function onDetailEdit( $param )
    {
        ...
        $criteria = TCriteria::create( ['cargo_id' => $param['cargo_id'] ] );
            ...
            TDBCombo::reloadFromModel('form_CTD', 'detail_especialidade_id', 'rh', 'ViewEspecialidadeCargo', 'id', 'nome', null, $criteria, TRUE);
    ...
    function onSave($param)
    {
        try
        {
            ...
            TForm::sendData('form_CTD', (object) ['id' => $master->id]);
    ...
    public static function onListaEspecialidade($param)
    {
        try
        {
            ...
            {
                TDBCombo::clearField('form_CTD', 'detail_especialidade_id');
            }
