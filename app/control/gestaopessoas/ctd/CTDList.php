...
class CTDList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_ctd_list');
        $this->form->setFormTitle('Contrato - Lista de Pessoas');
        ...
        //$this->form->addActionLink('Cadastrar Contrato', new TAction(['CTDForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['CTDForm', 'onEdit'], ['id'=>'{id}']);
