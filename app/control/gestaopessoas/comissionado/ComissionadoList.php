 ...
 * 
 */
class ComissionadoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_comissionado_list');
        $this->form->setFormTitle('Comissionado - Lista de Pessoas');
        ...
        //$this->form->addActionLink('Cadastrar Comissionado', new TAction(['ComissionadoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['ComissionadoForm', 'onEdit'], ['id'=>'{id}']);
