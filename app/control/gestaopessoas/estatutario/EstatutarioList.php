 ...
 * 
 */
class EstatutarioList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_estatutario_list');
        $this->form->setFormTitle('Concursado - Lista de Pessoas');
        ...
        //$this->form->addActionLink('Cadastrar Concursado', new TAction(['EstatutarioForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['EstatutarioForm', 'onEdit'], ['id'=>'{id}']);
