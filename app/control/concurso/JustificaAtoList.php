 ...
 * 
 */
class JustificaAtoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_JustificativaAto_list');
        $this->form->setFormTitle('Lista de Justificativas de Criação de Ato');
        
        // create the form fields
        $id = new TEntry('id');
        $nome = new TEntry('Justificativa');        
        ...
        $row = $this->form->addFields(  [ new TLabel('Justificativa'), $nome ]
                                        );
        $row->layout = ['col-sm-3'];
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['JustificaAtoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['JustificaAtoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = JustificativaAto::find($param['id']);
            
            if ($srv instanceof JustificativaAto)
            {
