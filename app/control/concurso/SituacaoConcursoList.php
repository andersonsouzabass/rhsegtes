 ...
 * 
 */
class SituacaoConcursoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('SituacaoConcurso');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_SituacaoConcurso_list');
        $this->form->setFormTitle('Lista de Situações dos Nomeados do Concurso');
        ...
        $row = $this->form->addFields(  [ new TLabel('Situação'), $nome ]
                                        );
        $row->layout = ['col-sm-3'];
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['SituacaoConcursoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Situação', 'left');               
        ...
        $action1 = new TDataGridAction(['SituacaoConcursoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = SituacaoConcurso::find($param['id']);
            
            if ($srv instanceof SituacaoConcurso)
            {
