 ...
 * 
 */
class FuncaoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_funcao_list');
        $this->form->setFormTitle('Lista de Funções');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['FuncaoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['FuncaoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Funcao::find($param['id']);
            
            if ($srv instanceof Funcao)
            {
