...
class CargoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Cargo');   // defines the active record
        ...
        $this->form->setFormTitle('Lista de Cargos');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['CargoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['CargoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Cargo::find($param['id']);
            
            if ($srv instanceof Cargo)
            {
