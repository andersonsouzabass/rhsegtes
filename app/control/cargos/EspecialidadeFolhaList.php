 ...
 * 
 */
class EspecialidadeFolhaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_especialidadefolha_list');
        $this->form->setFormTitle('Lista de Cargos Folha');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['EspecialidadeFolhaForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['EspecialidadeFolhaForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = EspecialidadeFolha::find($param['id']);
            
            if ($srv instanceof EspecialidadeFolha)
            {
