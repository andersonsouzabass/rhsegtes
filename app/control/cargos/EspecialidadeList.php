...
class EspecialidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_especialidade_list');
        $this->form->setFormTitle('Lista de Especialidades');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['EspecialidadeForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['EspecialidadeForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Especialidade::find($param['id']);
            
            if ($srv instanceof Especialidade)
            {
