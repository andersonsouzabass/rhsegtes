 ...
 * 
 */
class RegimeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_regime_list');
        $this->form->setFormTitle('Lista de Regimes de Trabalho');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['RegimeForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $column_tipo = new TDataGridColumn('tipo', 'Texto para Carta', 'left');
        ...
        $action1 = new TDataGridAction(['RegimeForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Regime::find($param['id']);
            
            if ($srv instanceof Regime)
            {
