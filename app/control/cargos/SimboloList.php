 ...
 * 
 */
class SimboloList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_simboloe_list');
        $this->form->setFormTitle('Lista de Simbolos');
        ...
        $this->form->addActionLink('Cadastrar  ', new TAction(['SimboloForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['SimboloForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Simbolo::find($param['id']);
            
            if ($srv instanceof Simbolo)
            {
