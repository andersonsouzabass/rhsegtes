 ...
 * 
 */
class TipoUnidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_tipo_unidade_list');
        $this->form->setFormTitle('Tipo da Unidade');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['TipoUnidadeForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['TipoUnidadeForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $und = TipoUnidade::find($param['id']);
            
            if ($und instanceof TipoUnidade)
            {
                $und->ativo = $und->ativo == 'sim' ? 'não' : 'sim';
                $und->store();
            }
