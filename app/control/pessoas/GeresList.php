...
class GeresList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_geres_list');
        $this->form->setFormTitle('Gerência Regional de Saúde - GERES');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['GeresForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['GeresForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $und = Geres::find($param['id']);
            
            if ($und instanceof Geres)
            {
