...
class GrupoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_grupo_list');
        $this->form->setFormTitle('Perfil da Unidade');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['GrupoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['GrupoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $und = Grupo::find($param['id']);
            
            if ($und instanceof Grupo)
            {
