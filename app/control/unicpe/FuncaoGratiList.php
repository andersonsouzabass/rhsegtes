 ...
 * 
 */
class FuncaoGratiList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_funcaograti_list');
        $this->form->setFormTitle('Lista de Funções Gratificadas e Cargos Comissionados');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['FuncaoGratiForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['FuncaoGratiForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = FuncaoGrati::find($param['id']);
            
            if ($srv instanceof FuncaoGrati)
            {
