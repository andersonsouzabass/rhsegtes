 ...
 * 
 */
class SituacaoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_situacao_list');
        $this->form->setFormTitle('Lista de Situações da Folha');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['SituacaoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['SituacaoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = SituacaoFolha::find($param['id']);
            
            if ($srv instanceof SituacaoFolha)
            {
