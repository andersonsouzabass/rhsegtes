 ...
 * 
 */
class TipoAssuntoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('TipoAssunto');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_tipo_assunto_list');
        $this->form->setFormTitle('Lista de Tipos de Assuntos');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['TipoAssuntoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $column_prazo = new TDataGridColumn('prazo', 'Prazo', 'left');     
        ...
        $action1 = new TDataGridAction(['TipoAssuntoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = TipoAssunto::find($param['id']);
            
            if ($srv instanceof TipoAssunto)
            {
