...
class SetorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Setor');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_setor_list');
        $this->form->setFormTitle('Lista de Setores da Folha');
        ...
        $row = $this->form->addFields(  [ new TLabel('Setor'), $nome ]
                                        );
        $row->layout = ['col-sm-3'];
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['SetorForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Setor', 'left');               
        ...
        $action1 = new TDataGridAction(['SetorForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Setor::find($param['id']);
            
            if ($srv instanceof Setor)
            {
