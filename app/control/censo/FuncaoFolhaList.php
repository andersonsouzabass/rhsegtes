 ...
 * 
 */
class FuncaoFolhaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('FuncaoFolha');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_funcaofolha_list');
        $this->form->setFormTitle('Lista de Funções da Folha');
        ...
        $this->form->addActionLink('Cadastrar', new TAction(['FuncaoFolhaForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['FuncaoFolhaForm', 'onEdit'], ['id'=>'{id}']);
