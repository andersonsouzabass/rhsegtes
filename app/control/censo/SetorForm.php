...
class SetorForm extends TWindow
{
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_SetorFolha');
        $this->form->setFormTitle( 'Criar Setor Folha' );
        ...
        $ativo->setValue('sim');
        TQuickForm::hideField('form_SetorFolha', 'ativo');
        ...
        $this->form->addAction( 'Cancelar',  new TAction(['SetorList', 'onReload']), 'fa:times red' );

        //Botões do cabeçalho
        
        $this->form->addHeaderActionLink( 'Fechar',  new TAction(['SetorList', 'onReload']), 'fa:times red' );
    ...
    public function onSave($param)
    {
        try
        {
            ...
            $data = new stdClass;
            $data->id = $object->id;
            TForm::sendData('form_SetorFolha', $data);
