 ...
 */
class UsuarioUnidadeForm_temp extends TWindow
{
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_unidade_usuario');
        $this->form->setFormTitle( 'Censo - Conceder Acesso à uma Unidade' );
        ...
        $this->form->addHeaderActionLink( 'Fechar',  new TAction(['UsuarioUnidadeList', 'onReload']), 'fa:times red' );
