...
class FolhaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setCriteria($lista_unidade_acesso); //Carrega apenas os servidores das unidades setadas
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_folha_list');
        $this->form->setFormTitle('Lista de Servidores da Folha');
        ...
        */
        ...
        $action1 = new TDataGridAction(['CensoForm', 'onEdit'], ['id'=>'{id}']);
        //$action2 = new TDataGridAction([$this, 'onTurnOnOff'], ['id'=>'{id}']);
        $action3 = new TDataGridAction([$this, 'onDelete'], ['id'=>'{id}']);
        
        $this->datagrid->addAction($action1, 'Validar Censo',   'far:edit blue');
